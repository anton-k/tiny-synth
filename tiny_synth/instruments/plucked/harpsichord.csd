...
ar2 upsamp kr0
kr0 linsegr 1.0, 1.0, 1.0, 0.13, 0.0
ar4 upsamp kr0
ar5 = (ar2 * ar4)
ar2 = (0.65 * ar5)
ir11 = 1.0
...
kr0 = cpsmidinn(ir12)
ir14 = cpsmidinn(ir12)
ar4 pluck ir11, kr0, ir14, 0.0, 1.0
ar5 transeg 1.0, 10.0, -5.0, 0.0, 1.0, 0.0, 0.0
kr1 downsamp ar5
ar5 poscil kr1, kr0, 2
ar6 balance ar4, ar5
ar5 = (ar4 + ar6)
ar4 = (0.5 * ar5)
ar5 = (ar2 * ar4)
...
f2 0 2048 7  -1.0 1024.0 1.0 1024.0 -1.0
