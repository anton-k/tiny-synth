...
ar2 upsamp kr0
ar3 = (1.0 * ar2)
kr0 linseg 0.0, 7.0e-2, 1.0, 1.0, 1.0
ar2 upsamp kr0
...
ir14 = p4
kr1 = cpsmidinn(ir14)
ar4 oscil3 ir13, kr1, 2
ar6 = (0.5 * ar4)
ar7 = (ar4 / 2.0)
ar4 = (0.5 + ar7)
ir20 = 2.3
kr2 oscil3 ir13, ir20, 4
ar7 upsamp kr2
ar8 = (ar7 * 0.1)
ar7 = (ar8 + 0.2)
ar8 = (ar4 + ar7)
...
f6 0 2048 7  -1.0 1024.0 -1.0 0.0 1.0 1024.0 1.0
f2 0 2048 7  -1.0 2048.0 1.0
f4 0 8192 10  1.0
